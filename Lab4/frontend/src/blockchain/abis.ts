...
export const precatorioMarketplaceAbi = [
  ...
  {
    type: "function",
    name: "activeOfferByBuyerAndToken",
    stateMutability: "view",
    inputs: [
      { name: "", type: "address" },
      { name: "", type: "uint256" },
...
export const monetaryOracleAbi = [
  ...
  },
  {
    ...
    name: "adjustedValue",
    stateMutability: "view",
    inputs: [{ name: "faceValue", type: "uint256" }],
    outputs: [{ name: "", type: "uint256" }],
  },
  {
    type: "function",
...
export const compensationManagerAbi = [
  {
    type: "event",
    name: "FiscalDebtRegistered",
    anonymous: false,
    inputs: [
      { name: "debtId", type: "uint256", indexed: true },
      { name: "identifier", type: "bytes32", indexed: true },
  ...
  },
  {
    ...
    anonymous: false,
    inputs: [
      { name: "compensationId", type: "uint256", indexed: false },
      { name: "tokenId", type: "uint256", indexed: true },
      { name: "debtId", type: "uint256", indexed: true },
      { name: "creditor", type: "address", indexed: true },
      { name: "faceValue", type: "uint256", indexed: false },
      { name: "adjustedValue", type: "uint256", indexed: false },
  ...
  },
  {
    ...
    outputs: [{ name: "debtId", type: "uint256" }],
  },
  {
    type: "function",
    name: "compensate",
    ...
    inputs: [
      { name: "tokenId", type: "uint256" },
      { name: "debtId", type: "uint256" },
    ],
    outputs: [{ name: "compensationId", type: "uint256" }],
  },
  {
    type: "function",
    name: "pause",
